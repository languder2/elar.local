<div class="container-lg">
    <div class="row">
        ...
        <div class="col-lg col-sm-4 pt-2 fs-5 text-end">
            <a href="<?=base_url('admin/sources/add')?>" class="btn btn-primary w-75">
                Создать
            </a>
        </div>
    </div>
        ...
        <?php if(isset($edSource)) foreach ($edSource as $source):?>
            ...
            <div>
                <div class="form-check form-switch">
                    <input class="form-check-input float-none changeVisible" data-link="/admin/sources/change-visible" type="checkbox" id="changeVisible-Section<?=$source->id?>" data-id="<?=$source->id?>" <?=$source->display?"checked":""?>>
                </div>
            </div>
            <div>
                <a class="btn btn-primary btn-sm" href="<?=base_url("admin/sources/edit/$source->id")?>"><i class="bi bi-pencil"></i></a>
            </div>
            <div>
                <a class="btn btn-danger btn-sm"
                   href="<?=base_url("admin/sources/delete/$source->id")?>"
